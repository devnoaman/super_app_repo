...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,logoUrl,description,version,requiredVersion,url,apiKey,primaryColor,const DeepCollectionEquality().hash(requiredPermissions));

@override
String toString() {
  return 'MiniAppEntity(id: $id, name: $name, logoUrl: $logoUrl, description: $description, version: $version, requiredVersion: $requiredVersion, url: $url, apiKey: $apiKey, primaryColor: $primaryColor, requiredPermissions: $requiredPermissions)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,logoUrl,description,version,requiredVersion,url,apiKey,primaryColor,const DeepCollectionEquality().hash(_requiredPermissions));
